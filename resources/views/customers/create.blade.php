<x-app-layout>
	<x-slot name="header"><h2 class="font-semibold text-2xl leading-tight title-gradient"><i class="bi bi-person-plus me-2"></i>Add Customer</h2></x-slot>
	<div class="page-wrap py-8">
		<div class="mx-auto max-w-3xl">
			...
			@endif
			<form method="POST" action="{{ route('customers.store') }}" enctype="multipart/form-data" class="panel space-y-4 p-6">
				@csrf
				...
				<div class="flex items-center gap-2"><button class="btn-primary"><i class="bi bi-check-circle me-1"></i>Save</button><a href="{{ route('customers.index') }}" class="btn-secondary"><i class="bi bi-arrow-left me-1"></i>Back</a></div>
			</form>
		</div>
	</div>
</x-app-layout>